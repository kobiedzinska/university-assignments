...
public class PetitionCancelCheck implements CheckStrategy {
	...
	public Boolean checkPetition(Petition petition) {
		...
		if (petition instanceof PetitionService){
			...
			PetitionCancel petition1 = (PetitionCancel) petition;
			Client petitioner = petition1.getPetitioner();
			String data1 = petition1.getDescription();
			String data2 = petition1.getJustification();
