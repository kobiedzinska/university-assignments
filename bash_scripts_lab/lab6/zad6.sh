...
#
#Program "du" to uniksowe polecenie (część pakietu Coreutils), które służy do oszacowania wykorzystania przestrzeni dyskowej. Pozwala wyświetlić rozmiary plików i katalogów, i może być użyte do identyfikacji tych, które zajmują najwięcej miejsca na dysku.
#
find coreutils-8.32 -type f -ls | awk '
	BEGIN {	total=0; }
	{
		total+=$7;
	}
