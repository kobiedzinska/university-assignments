...
if [ ! -d ddd ] ; then
mkdir ddd
echo "Folder został utworzony"
fi

if [ ! -f "ddd/drugi" ] || [ "$(cat ddd/drugi)" != "Ala ma kota." ]; then
    echo "Ala ma kota." > ddd/drugi
    echo "Plik został utworzony i zapisany."
else
    echo "Plik już istnieje i zawiera 'Ala ma kota'."
fi
