...
# element (i,j) połączyć jednocześnie z (i + 1,j) oraz (i,j + 1)
# konieczne będzie także narysowanie trójkąta dopełniającego;
    ...
    for i in range(N-1):
        for j in range(N-1):
            ...
            # Tworzenie dwóch trójkątów w celu wypełnienia kwadratu
            # Pierwszy trójkąt: wierzchołki (i,j), (i+1,j), (i,j+1)
            # Drugi trójkąt: wierzchołki (i+1,j), (i,j+1), (i+1,j+1)
